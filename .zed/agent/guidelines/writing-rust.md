...
## 8. Doc Comments for API References
...
## 10. Use descriptive names for all variables
...
## 11. Prefer self-contained functions with clear data flow
...
## 12. Use module-prefixed function calls for internal modules
